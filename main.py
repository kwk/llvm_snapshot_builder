...
from src.llvm_snapshot_builder.copr_action import CoprAction
from src.llvm_snapshot_builder.copr_action_build_all_packages import CoprActionBuildAllPackages
from src.llvm_snapshot_builder.copr_action_build_packages import CoprActionBuildPackages
from src.llvm_snapshot_builder.copr_action_cancel_builds import CoprActionCancelBuilds
from src.llvm_snapshot_builder.copr_action_delete_builds import CoprActionDeleteBuilds
from src.llvm_snapshot_builder.copr_action_delete_project import CoprActionDeleteProject
from src.llvm_snapshot_builder.copr_action_fork_project import CoprActionForkProject
from src.llvm_snapshot_builder.copr_action_make_or_edit_packages import CoprActionMakeOrEditPackages
from src.llvm_snapshot_builder.copr_action_make_or_edit_project import CoprActionMakeOrEditProject
from src.llvm_snapshot_builder.copr_action_project_exists import CoprActionProjectExists
from src.llvm_snapshot_builder.copr_action_regenerate_repos import CoprActionRegenerateRepos
from src.llvm_snapshot_builder.copr_project_ref import CoprProjectRef


def get_action(arg_parser: argparse.ArgumentParser) -> CoprAction:
    """ The main program """
...
if __name__ == "__main__":
    parser_main = build_main_parser()
    action = get_action(parser_main)
    if (result := action.run()) is False:
        # print(f"ERROR: action {action} failed with exit code: {result}")
